public class Carro25 {
    ...
    public Boolean getArmamento(Boolean armamento){
        return this.armamento=armamento;
    }
    ...
    public void info(){
        ...
        System.out.printf("Destruindo.................:%s%n",this.destruido ? "Sim" : "Nao");
